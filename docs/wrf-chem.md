...
The EPA_ANTHRO_EMIS tool allows the user to create WRF-Chem compatible hourly
anthropogenic emission input files from Sparse Matrix Operator Kernel (SMOKE) Modeling
System netcdf output.
...
[<img src="/assets/img/anthrofilechange.png">]()
